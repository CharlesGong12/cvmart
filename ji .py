...
class YoloDetector:
    ...
    def detect(self, input_image):
        detections = self.model.predict(input_image, device='cuda')
        return detections

def init():
    model = YoloDetector('/project/train/models/yolov8m/train/weights/best.pt')
    return model
...
# process_image('/home/images/val/ZDStraffic_sign20231108_V4_train_street_417_102.jpg')